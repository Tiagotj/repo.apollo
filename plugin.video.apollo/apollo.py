...
#### CONFIGURAÇÕES ####
#### LINK DO ARQUIVO DO MENU PRINCIPAL - BASE64 #######################################
url_b64_principal = 'aHR0cHM6Ly9hcG9sbG8tYXJxdWl2b3MudGsvQVBPTExPL0JBU0UtUFJJTkNJUEFML0Jhc2UtUHJpbmNpcGFsLmh0bWw='
url_principal = base64.b64decode(url_b64_principal)

###RC REGEX
regex_canais = ""

####  TITULO DO MENU  #################################################################
title_menu = '[COLOR orange][B]->[/COLOR][/B][COLOR deepskyblue][B] BEM-VINDOS[/COLOR][/B]'
#######################################################################################

####  TORRENT  #################################################################
title_menu2 = '-> BAIXE E INSTALE!'
#######################################################################################
#######################################################################################
###  DESCRIÇÃO DO ADDON ###############################################################
### OBS: PARA SALTAR UMA LINHA UTILIZE \n #############################################
url_b64_title_descricao = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3LzJQTk4xUGpL'
url_title_descricao = base64.b64decode(url_b64_title_descricao)
#######################################################################################

#######################################################################################
###  DESCRIÇÃO DO ADDON ###############################################################
### OBS: PARA SALTAR UMA LINHA UTILIZE \n #############################################
url_b64_title_descricao2 = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3BYR2gyckVu'
url_title_descricao2 = base64.b64decode(url_b64_title_descricao2)
#######################################################################################

####  MENSAGEM DO STATUS BASE 64 ##############################################################
url_b64_mensagem = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L1hDdDl6clRm'
url_mensagem = base64.b64decode(url_b64_mensagem)
#######################################################################################
...
url_b64_branco = 'aHR0cHM6Ly91cmxwbGF5LmNvbS9OMHJkTEI='
url_branco = base64.b64decode(url_b64_branco)
#######################################################################################

###### VERIFICAR USER AGENT ###########################################################
#### padrão é 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0'
useragent = 'ǭq�{���}���w���'
##############################################################################

#### MENU TORRENT ################################################################
titulo_TORRENT = 'TORRENT'
thumbnail_TORRENT = 'https://i.imgur.com/OKPqt3k.png'
fanart_TORRENT = 'https://i.imgur.com/By1pLrx.jpg'
#### DESCRIÇÃO ADVANCED TORRENT ###########################################################
url_b64_TORRENT_descricao = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0JVYk5CWlFB'
url_TORRENT_descricao = base64.b64decode(url_b64_TORRENT_descricao)
#### DIALOGO ADVANCED TORRENT - SERVIDOR DESATIVADO - CLICK ###################################
url_b64_TORRENT_dialogo = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0JVYk5CWlFB'
url_TORRENT_dialogo = base64.b64decode(url_b64_TORRENT_dialogo)

##############################################################################

### DIALOGO
dialog1 = '[COLOR white]Selecione um item:[/COLOR]'
## youtube download (youtube-dl)
dialog2 = '[COLOR white]!!Download em execução!![/COLOR]'
dialog3 = '!!Download [COLOR seablue]Audio!![/COLOR]'


## MENU ATUALIZAÇÃO
menu_atualizacao = '[COLOR deepskyblue][B] CHECAR POR ATUALIZAÇÃO[/COLOR][/B]'
thumb_update = 'https://i.imgur.com/22LSvnr.png'
url_b64_atualizacao = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2E5dE1DMEh1'
url_desc_atualizacao = base64.b64decode(url_b64_atualizacao)

#######################################################################################
####  MENSAGEM DO BEM VINDOS BASE 64 ######################################################
titulo_boas_vindas = 'BEM-VINDOS'
url_b64_bem_vindo = 'aHR0cHM6Ly9pLmltZ3VyLmNvbS8ydWtIaE9hLnBuZw=='
thumbnail_boas_vindas = 'https://i.imgur.com/2ukHhOa.png'
fanart_boas_vindas = 'https://i.imgur.com/nuOWFDB.jpg'
url_mensagem_bem_vindo = base64.b64decode(url_b64_bem_vindo)
######################################################################################

### REGEX DIALOGO MULTILINK - PADRÃO É $$lsname=
regexdialog = '$texto='
color_multilink = 'orange'
name_multilink = 'itens'

### INFO DO ADDON PARA MENSAGEM
...
icon_config = os.path.join(home, 'icon_config.png')
favorites2 = os.path.join(home, 'favorites.png')
...
def addon_log(string):
    if debug == 'true':
       # xbmc.log("[addon.live.SimpleKore Lists-%s]: %s" %(addon_version, string))
        xbmc.log("[APOLLO-%s]: %s" %(addon_version, string))

#Modulos
exec(module_import('https://gitlab.com/silvadeivison566/gitplay/-/raw/master/APOLLO_INFORMA'))
...
def getRequest(url, ref,useragent=False):
    try:
        ...
        if useragent:
            ...
            client_user = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36'
...
def SUPORTE(msg):
   suporte = addon.getSetting('suporte')
   if suporte == 'true':
    addDir(title_menu2,url_branco,44,thumbnail_TORRENT,FANART,descricao(url_title_descricao2),'','','','','','','','','','','','','','','')

def init_SUPORTE(msg):
    ...
    link = dialog.select('[COLOR orange][B]PARA ASSISTIR FILMES EM 4K LINKS ABAIXO![/COLOR][/B]', ['[COLOR deepskyblue][B]BAIXAR[/COLOR][/B][COLOR orange][B] ELEMENTUM[/COLOR][/B]','[COLOR deepskyblue][B]BAIXAR[/COLOR][/B][COLOR orange][B] ELEMENTUM BURST[/COLOR][/B]',''])
    if link == 0:
        if xbmc . getCondVisibility ( 'system.platform.android' ) :
            xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://github.com/elgatito/plugin.video.elementum/releases/download/v0.1.74/plugin.video.elementum-0.1.74.zip' ) )
        else:
            webbrowser . open ( 'https://github.com/elgatito/plugin.video.elementum/releases/download/v0.1.74/plugin.video.elementum-0.1.74.zip' )
    if link == 1:
        if xbmc . getCondVisibility ( 'system.platform.android' ) :
            xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://github.com/elgatito/context.elementum/releases/download/v0.0.5/context.elementum-0.0.5.zip' ) )
        else:
            webbrowser . open ( 'https://github.com/elgatito/context.elementum/releases/download/v0.0.5/context.elementum-0.0.5.zip' )
            
    if link == 5:
     xbmcaddon.Addon().openSettings()
     #xbmcgui.Dialog().ok('[B][COLOR deepskyblue]AVISO IMPORTANTE![/COLOR][/B]','[COLOR orange][B]PARA QUE AS CONFIGURAÇÕES DO (TORRENT) SEJA ATIVADO NO MENU INICIAL DO ADD-ON SAIA E ENTRE NOVAMENTE NO ADD-ON LOGO APÓS TER SAIDO VOCÊ JÁ PODÊ ACESSAR O TORRENT!! OBS. VOCÊ TEM QUE TER CONTRATADO ANTES![/COLOR][/B]')
     xbmc.executebuiltin("XBMC.Container.Refresh(%s?mode=None, replace)"%sys.argv[0])
     xbmcplugin.endOfDirectory(int(sys.argv[1]))
            
def TORRENT():
    username_TORRENT = addon.getSetting('username')
    password_TORRENT = addon.getSetting('password')
    tipo_servidor = addon.getSetting('servidor')
    TORRENT_menu = addon.getSetting('exibirTORRENT')
    saida_transmissao = addon.getSetting('saida')
    if TORRENT_menu == 'true':
        if tipo_servidor=='TORRENT':
            url = 'http://sv1.iptvcasa.online:25461/get.php?username=%s&password=%s&type=m3u_plus&output=%s'%(username_TORRENT,password_TORRENT,saida_transmissao)
            addDir(titulo_TORRENT,url,1,thumbnail_TORRENT,fanart_TORRENT,descricao(url_TORRENT_descricao),'','','','','','','','','','','','','','','')
        if tipo_servidor=='Nenhum':
            addDir(titulo_TORRENT,'',42,thumbnail_TORRENT,fanart_TORRENT,descricao(url_TORRENT_descricao),'','','','','','','','','','','','','','','')
    username_TORRENT = addon.getSetting('username2')
    password_TORRENT = addon.getSetting('password2')
    tipo_servidor = addon.getSetting('servidor2')
    TORRENT_menu = addon.getSetting('exibirTORRENT2')
    saida_transmissao = addon.getSetting('saida2')
    if TORRENT_menu == 'true':
        if tipo_servidor=='TORRENT':
            url = 'http://cloudsteam.club:8080/get.php?username=%s&password=%s&type=m3u_plus&output=%s'%(username_TORRENT,password_TORRENT,saida_transmissao)
            addDir(titulo_TORRENT2,url,1,thumbnail_TORRENT2,fanart_TORRENT,descricao(url_TORRENT_descricao),'','','','','','','','','','','','','','','')
        if tipo_servidor=='Nenhum':
            addDir(titulo_TORRENT2,'',42,thumbnail_TORRENT2,fanart_TORRENT2,descricao(url_TORRENT_descricao),'','','','','','','','','','','','','','','')
...
def redecanais(channel):
    try:
        #canal = str(re.compile('rdc=(.*)').findall(url)[0])
        canal = str(channel)
        regex = getRequest(regex_canais, '').replace('\n','').replace('\r','')
        ...
        data = getRequest(str(player)+canal,str(referer)+canal,user_agent)
...
def SKindex(msg):
    addDir(title_menu,url_branco,1,icon,FANART,descricao(url_title_descricao),'','','','','','','','','','','','','','','')
    SUPORTE(True)
    TORRENT()
    ### BASE #############
    getData(url_principal,'')
    addDir(menu_atualizacao,'',54,thumb_update,FANART,descricao(url_desc_atualizacao),'','','','','','','','','','','','','','','')
    ### MENSAGEM #########
    mensagem()
    init_SKindex(True)
    ######################
...
def Init_CheckUpdate(msg): #43
	try:
		uversao = urllib2.urlopen( "https://github.com/Tiagotj/repo.apollo/raw/master/plugin.video.apollo/version.txt" ).read().replace('','').replace('\r','')
		...
		if uversao != Versao:
			...
			#xbmcgui.Dialog().ok('[COLOR orange][B]APOLLO [/COLOR][/B]', "[COLOR deepskyblue][B]JÁ ESTÁ NA ÚLTIMA VERSÃO! [/COLOR][/B] "+Versao+" [COLOR deepskyblue][B]ATUALIZAÇÕES SÃO AUTOMÁTICAS SE NÃO ATUALIZA ENTRE NO SITE [/COLOR][/B][COLOR orange][B]https://apollosite.ml [/COLOR][/B]\n[COLOR deepskyblue][B]USEM ESSE RECURSO CASO NÃO RECEBA AUTOMÁTICAMENTE[/COLOR][/B]")
			init_SKindex(True)
			#xbmc.executebuiltin("XBMC.Container.Refresh()")
...
def CheckUpdate(msg): #54
	try:
		...
		if uversao != Versao:
			...
			xbmcgui.Dialog().ok('[COLOR orange][B]APOLLO [/COLOR][/B]', "[COLOR deepskyblue][B]O ADD-ON JÁ ESTÁ NA ÚLTIMA VERSÃO! [/COLOR][/B][COLOR orange][B]1.6.0 [/COLOR][/B] "+Versao+"[COLOR deepskyblue][B]ATUALIZAÇÕES SÃO AUTOMÁTICAS SE NÃO ATUALIZA ENTRE NO SITE [/COLOR][/B][COLOR orange][B]https://apollosite.ml[/COLOR][/B]")
			#xbmc.executebuiltin("XBMC.Container.Refresh()")
	except urllib2.URLError, e:
		if msg==True:
			xbmcgui.Dialog().ok('Apollo', "Não foi possível checar")
...
def Update():
	...
	try:
		fonte = urllib2.urlopen( "https://github.com/Tiagotj/repo.apollo/raw/master/plugin.video.apollo/apollo.py" ).read().replace('','')
		...
		if prog:
			...
			file.write(fonte)
			file.close()
		fonte = urllib2.urlopen( "https://github.com/Tiagotj/repo.apollo/raw/master/plugin.video.apollo/resources/settings.xml" ).read().replace('','')
		...
		if prog:
			...
			file.write(fonte)
			file.close()
		fonte = urllib2.urlopen( "https://github.com/Tiagotj/repo.apollo/raw/master/plugin.video.apollo/addon.xml" ).read().replace('','')
...
def contador():
    ...
    "Referer": "APOLLO 1.5.6 TRAZENDO O MELHOR DO CINEMA 100% GRÁTIS!",
    "Connection": "APOLLO 1.6.0" 
    }
...
def makeRequest(url, headers=None):
        try:
	       ...
	       #### HEADER PADRAO
            ...
            addon_log('URL: '+url)
            if hasattr(e, 'code'):
                addon_log('Falha com o código de erro - %s.' % e.code)
                # xbmc.executebuiltin("XBMC.Notification(SimpleKore,We failed with error code - "+str(e.code)+",10000,"+icon+")")
                ### FALHA MENSAGEM
                xbmc.executebuiltin("XBMC.Notification(Falha, código de erro - "+str(e.code)+",10000,"+icon+")")               
            elif hasattr(e, 'reason'):
                addon_log('Falha ao acessar um servidor.')
                addon_log('Razão: %s' %e.reason)
               # xbmc.executebuiltin("XBMC.Notification(SimpleKore,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
                xbmc.executebuiltin("XBMC.Notification(Falha, motivo - "+str(e.reason)+",10000,"+icon+")")
...
def mensagem():
   ...
   if status_mensagem2 == 'true':
        ...
        response = opener.open(url_mensagem)
        line1 = response.read()
            ...
            if len(sources) > 1:
                for i in sources:
                    ...
                    if isinstance(i, list):
                        ...
                        if i.has_key('rate'):
                            rate = i['rate']
                        if i.has_key('originaltitle'):
                            originaltitle = i['originaltitle']
                        if i.has_key('country'):
                            country = i['country']
                        if i.has_key('rating'):
                            rating = i['rating']
                        if i.has_key('userrating'):
                            userrating = i['userrating']
                        if i.has_key('votes'):
                            votes = i['votes']
                        if i.has_key('aired'):
                            aired = i['aired']	                            
                        addDir(i['title'].encode('utf-8'),i['url'].encode('utf-8'),1,thumb,fanart,desc,genre,date,credits,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,'source')
...
def addSource(url=None):
        ...
        if media_info:
            ...
            try: source_media['year'] = media_info.year.string
            except: pass
            try: source_media['director'] = media_info.director.string
            except: pass
            try: source_media['premiered'] = media_info.premiered.string
            except: pass
            try: source_media['studio'] = media_info.studio.string
            except: pass
            try: source_media['rate'] = media_info.rate.string
            except: pass						
            try: source_media['originaltitle'] = media_info.originaltitle.string
            except: pass
            try: source_media['country'] = media_info.country.string
            except: pass
            try: source_media['rating'] = media_info.rating.string
            except: pass
            try: source_media['userrating'] = media_info.userrating.string
            except: pass
            try: source_media['votes'] = media_info.votes.string
            except: pass
            try: source_media['aired'] = media_info.aired.string
            except: pass            
        else:
            if '/' in source_url:
        ...
        if url.startswith('http://') or url.startswith('https://'):
            ...
            try:  
                ...
                if 'tgjds'[::-1]in data:
                 ...
                 buf = StringIO(binascii.unhexlify(data[0]))
...
#                print channel
                ...
                try:
                    duration = channel('duration')[0].string
                    if duration == None:
                        raise
                except:
                    duration = ''
                ...
                try:
                    premiered = channel('premiered')[0].string
                    if premiered == None:
                        raise
                except:
                    premiered = ''
                ...
                try:
                    studio = channel('studio')[0].string
                    if studio == None:
                        raise
                except:
                    studio = ''
                ...
                try:
                    originaltitle = channel('originaltitle')[0].string
                ...
                try:
                    country = channel('country')[0].string
                    if country == None:
                        raise
                except:
                    country = ''
                ...
                try:
                    mediatype = channel('mediatype')[0].string
                    if mediatype == None:
                        raise
                except:
                    mediatype = ''
                ...
                try:
                    userrating = channel('userrating')[0].string
                    if userrating == None:
                        raise
                except:
                    userrating = ''
                ...
                try:
                    if linkedUrl=='':
                        addDir(name.encode('utf-8', 'ignore'),url.encode('utf-8'),2,thumbnail,fanArt,desc,genre,date,credits,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,True)
                    else:
                        #print linkedUrl
                        addDir(name.encode('utf-8'),linkedUrl.encode('utf-8'),1,thumbnail,fanArt,desc,genre,date,None,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,'source')
                except:
...
#    print 'total m3u links',total
    for other,channel_name,stream_url in match:
        ...
        addLink2(stream_url, channel_name,thumbnail,'','','','','',None,'',total)
...
def getChannelItems(name,url,fanart):
        ...
        for channel in channel_list('subchannel'):
            ...
            try:
                addDir(name.encode('utf-8', 'ignore'),url.encode('utf-8'),3,thumbnail,fanArt,desc,genre,credits,date,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired)
            except:
...
def getItems(items,fanart,dontLink=False):
        ...
        for item in items:
            ...
            try:
                duration = item('duration')[0].string
                if duration == None:
                    raise
            except:
                duration = ''
            ...
            try:
                premiered = item('premiered')[0].string
                if premiered == None:
                    raise
            except:
                premiered = ''
                ...
                if len(url) > 1:
                    ...
                    for i in url:
                            if  add_playlist == "false":
                                alt += 1
                                addLink(i,'%s) %s' %(alt, name.encode('utf-8', 'ignore')),thumbnail,fanArt,desc,genre,date,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,True,playlist,regexs,total)
                                ...
                                playlist.append(i)
                    if len(playlist) > 1:
                        addLink('', name,thumbnail,fanArt,desc,genre,date,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,True,playlist,regexs,total)
                else:
                    ...
                    if isXMLSource:
                            if not regexs == None: #<externallink> and <regex>
                                addDir(name.encode('utf-8'),ext_url[0].encode('utf-8'),1,thumbnail,fanart,desc,genre,date,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,None,'!!update',regexs,url[0].encode('utf-8'))
                                #addLink(url[0],name.encode('utf-8', 'ignore')+  '[COLOR orange]build XML[/COLOR]',thumbnail,fanArt,desc,genre,date,True,None,regexs,total)
                            else:
                                addDir(name.encode('utf-8'),ext_url[0].encode('utf-8'),1,thumbnail,fanart,desc,genre,date,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,None,'source',None,None)
                                #addDir(name.encode('utf-8'),url[0].encode('utf-8'),1,thumbnail,fanart,desc,genre,date,None,'source')
                    elif isJsonrpc:
                        addDir(name.encode('utf-8'),ext_url[0],53,thumbnail,fanart,desc,genre,date,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,None,'source')
                        #xbmc.executebuiltin("Container.SetViewMode(500)")
                    else:
                        
                        addLink(url[0],name.encode('utf-8', 'ignore'),thumbnail,fanArt,desc,genre,date,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,True,None,regexs,total)
                    #print 'success'
            except:
...
def makeRequest(url, headers=None):
        try:
            if headers is None:
	       #### HEADER PADRAO
               #headers = {'\x55\x73\x65\x72\x2d\x61\x67\x65\x6e\x74' : 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0'}
...
def urlsolver(url):
    ...
    ##genesis_url = 'https://raw.githubusercontent.com/lambda81/lambda-addons/master/plugin.video.genesis/commonresolvers.py'
        genesis_url = 'https://raw.githubusercontent.com/KelTec-Maedia-Play/master/plugin.video.genesis/commonresolvers.py'
        ...
        if '$$LSPlayOnlyOne$$' in mu_playlist[0]:
            ...
            for i in mu_playlist:
                ...
                if regexdialog in i:
                    ...
                    d_name=i.split(regexdialog)[1].split('&regexs')[0]
                    names.append(d_name)                                       
                    #mu_playlist[iloop]=i.split('$$lsname=')[0]+('&regexs'+i.split('&regexs')[1] if '&regexs' in i else '')                    
                    mu_playlist[iloop]=i.split(regexdialog)[0]+('&regexs'+i.split('&regexs')[1] if '&regexs' in i else '')                    
                else:
...
#                    print sepate
        ...
        if addon.getSetting('ask_playlist_items') == 'true' and not queueVideo :
            ...
            index = dialog.select(dialog1, names)
            if index >= 0:
                playname=names[index]
...
def addDir2(name,url,mode,iconimage,fanart,description,genre,date,credits,showcontext=False,regexs=None,reg_url=None,allinfo={}):

        if mode == 1:
            u=sys.argv[0]+"?url="+urllib.quote_plus(codecs.encode(base64.b32encode(base64.b16encode(url)), 'rot_13'))+"&mode="+str(mode)+"&name="+urllib.quote_plus(name)+"&fanart="+urllib.quote_plus(fanart)
        else:
            u=sys.argv[0]+"?url="+urllib.quote_plus(codecs.encode(base64.b32encode(base64.b16encode(url)), 'rot_13'))+"&mode="+str(mode)+"&name="+urllib.quote_plus(name)+"&fanart="+urllib.quote_plus(fanart)
        ok=True
        if date == '':
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from KelTec-Media-Play Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
            ...
            if showcontext == '!!update':
                ...
                contextMenu.append(('[COLOR orange]!!update[/COLOR]','XBMC.RunPlugin(%s)' %fav_params2))
            if not name in FAV:
                fav_params = (
                ...
                #contextMenu.append(('Adicionar [COLOR orange]KelTec-Media-Play[/COLOR]','XBMC.RunPlugin(%s?mode=5&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
                         #%(sys.argv[0], urllib.quote_plus(name), urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(fanart), mode)))
            liz.addContextMenuItems(contextMenu)
        ok=xbmcplugin.addDirectoryItem(handle=int(sys.argv[1]),url=u,listitem=liz,isFolder=True)
        return ok

def addDir(name,url,mode,iconimage,fanart,description,genre,date,credits,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,showcontext=False,reg_url=None,regexs=None,allinfo={}):
        ...
        liz=xbmcgui.ListItem(name, iconImage="DefaultFolder.png", thumbnailImage=iconimage)
        if len(allinfo) <1 :
            liz.setInfo(type="Video", infoLabels={ "Title": name, "Plot": description, "Genre": genre, "dateadded": date, "credits": credits, "Year": year, "Director": director, "Duration": duration, "Premiered": premiered, "Studio": studio, "Mpaa": rate, "Originaltitle": originaltitle, "Country": country, "Rating": rating, "Userrating": userrating, "Votes": votes, "Aired": aired })
        else:
            liz.setInfo(type="Video", infoLabels= allinfo)
        liz.setProperty("Fanart_Image", fanart)
        if showcontext:
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from KelTec-Maedia-Play Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
                                    %(sys.argv[0], urllib.quote_plus(name))))
            if showcontext == '!!update':
                fav_params2 = (
                    '%s?url=%s&mode=17&regexs=%s'
            ...
            if not name in FAV:
                ...
                if regexs:
                    fav_params += "&regexs="+regexs
                ##contextMenu.append(('Adicionar [COLOR orange]KelTec-Maedia-Play[/COLOR]','XBMC.RunPlugin(%s?mode=5&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
                        ## %(sys.argv[0], urllib.quote_plus(name), urllib.quote_plus(url), urllib.quote_plus(iconimage), urllib.quote_plus(fanart), mode)))
            liz.addContextMenuItems(contextMenu)
        ok=xbmcplugin.addDirectoryItem(handle=int(sys.argv[1]),url=u,listitem=liz,isFolder=True)
        return ok
...
def search(site_name,search_term=None):
    ...
    if 'youtube' in site_name:
        ...
        if res == 'True':
            ...
            xbmc.executebuiltin("XBMC.Notification(No IMDB match found ,7000,"+icon+")")
...
def pluginquerybyJSON(url):
    ...
    for i in json_folder_detail['result']['files'] :
        ...
        if i['filetype'] == 'file':
            addLink2(url,name,thumbnail,fanart,description,'',date,'',None,'',total=len(json_folder_detail['result']['files']))
            #xbmc.executebuiltin("Container.SetViewMode(500)")

        else:
            addDir2(name,url,53,thumbnail,fanart,description,'',date,'')
            #xbmc.executebuiltin("Container.SetViewMode(500)")
            
def addLink2(url,name,iconimage,fanart,description,genre,date,showcontext,playlist,regexs,total,setCookie="",allinfo={}):
...
#                print 'setting as folder in link'
           ## contextMenu.append(('[COLOR white]!!Download Currently Playing!![/COLOR]','XBMC.RunPlugin(%s?url=%s&mode=21&name=%s)'
            contextMenu.append((dialog2,'XBMC.RunPlugin(%s?url=%s&mode=21&name=%s)'
                                    %(sys.argv[0], urllib.quote_plus(url), urllib.quote_plus(name))))
...
def addLink(url,name,iconimage,fanart,description,genre,date,year,director,duration,premiered,studio,rate,originaltitle,country,rating,userrating,votes,aired,showcontext,playlist,regexs,total,setCookie="",allinfo={}):
        #print 'url,name',url,name,iconimage
        contextMenu =[]
        parentalblock =addon.getSetting('parentalblocked')
        parentalblock= parentalblock=="true"
...
#                print 'setting as folder in link'
        ...
        if playlist:
            if addon.getSetting('add_playlist') == "false" and '$$LSPlayOnlyOne$$' not in playlist[0] :
                ...
                u += "mode=13&name=%s&playlist=%s" %(urllib.quote_plus(name), urllib.quote_plus(str(playlist).replace(',','||')))
                name = name + '[COLOR '+color_multilink+'] (' + str(len(playlist)) + ' '+name_multilink+')[/COLOR]'
                play_list = True
        else:
            u += "url="+urllib.quote_plus(url)+"&mode="+mode
        if regexs:
        ...
        #if isFolder:
        if allinfo==None or len(allinfo) <1:
            liz.setInfo(type="Video", infoLabels={ "Title": name, "Plot": description, "Genre": genre, "dateadded": date, "Year": year, "Director": director, "Duration": duration, "Premiered": premiered, "Studio": studio, "rate": rate, "Originaltitle": originaltitle, "Country": country, "Rating": rating, "Userrating": userrating, "Votes": votes, "Aired": aired })
        else:
            liz.setInfo(type="Video", infoLabels=allinfo)
        liz.setProperty("Fanart_Image", fanart)
...
def request_elementum():
    import ntpath
    data = getRequest('https://elementumorg.github.io/', '')
    ...
    for link, name in list_addons:
        if '-' in link and not 'Client' in name:
            ...
            tp = name.strip()
            if addon_id == 'plugin.video.elementum' and tp == 'Android x86' and xbmc.getCondVisibility('system.platform.android'):
                name_elementum = 'Elementum Android x86'
                directory = 'special://home/addons/'+addon_id
                elementum_list.append((name_elementum,addon_id,link,directory))
            elif addon_id == 'plugin.video.elementum' and tp == 'Universal':
                name_elementum = 'Elementum Universal'
                directory = 'special://home/addons/'+addon_id
                elementum_list.append((name_elementum,addon_id,link,directory))               
    if len(elementum_list) > 0:    
        name_addon = elementum_list[0][0]
        id_addon = elementum_list[0][1]
        link_addon = elementum_list[0][2]
        directory = elementum_list[0][3]
        status = 'true'
    else:
        name_addon = ''
        id_addon = ''
        ...
        directory = ''
        status = 'false'
    return name_addon,id_addon,link_addon,directory,status

def install_elementum():
    try:
        check_file = os.path.join(home, 'check.txt')
        if os.path.isfile(check_file):
            fcheck = open(check_file,'r+')
            if fcheck and fcheck.read() == '1':
                fcheck.close()
                name_addon,id_addon,link_addon,directory,status = request_elementum()
                if status == 'true':
                    if os.path.exists(xbmc.translatePath(directory)) == False:
                        if xbmcgui.Dialog().yesno(__addonname__, 'Deseja Instalar o Elementum?'):
                            install_addons(name_addon,id_addon,link_addon)           
        else:
...
def install_addons(name_addon,id_addon,link_addon):
    try:
        import downloader
        import database
        import ntpath
        filename = ntpath.basename(link_addon)
        path_download = xbmc.translatePath(os.path.join('special://','home/','addons', 'packages'))
        path_extract = xbmc.translatePath(os.path.join('special://','home/','addons'))
        dest=os.path.join(path_download, filename)
        downloader.download(link_addon, name_addon, dest)
        dp = xbmcgui.DialogProgress()
        dp.create("Install addons","Baixando "+name_addon+"....",'', '')
        xbmc.executebuiltin("Extract("+dest+","+path_extract+")")
        dp.update(100)
        dp.close()
        ...
        notify('%s instalado com sucesso' %name_addon)
    except:
...
if mode==None:
    ...
    addon_log("getData")
    data=None
    url = base64.b16decode(base64.b32decode(codecs.decode(url, 'rot_13')))
    if regexs:
...
#            ln+='</item>'
    ...
    addon_log("infoTORRENT")    
    ##xbmcaddon.Addon().openSettings()
    #xbmcgui.Dialog().ok('[COLOR gold][B](TORRENT) [/B][/COLOR][COLOR aquamarine][B]AREA ASSINANTES[/B][/COLOR]', dialog4)
    xbmcgui.Dialog().ok(titulo_TORRENT, descricao(url_TORRENT_dialogo))
    ##xbmc.executebuiltin("XBMC.Container.Refresh")
